...
%-----------------------------------------------------------------------------------------------
\title{O ``Fim'' de Mateus~24}
\subtitle{Estudo do \emph{timing} em Mt 24.1--14}
\author{Bíblia Share}
...
%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}
        \QUOTE{%
            ...
            %-----!j 92 -i12
            \ver{(ARA) Mt~24.13}~%
            Aquele, porém, que perseverar até o \MAG{fim}, esse será salvo.
            %-----!j 92 -i12
            \ver{14}~%
            E será pregado este evangelho do reino por todo o mundo, para testemunho a todas
            as nações. Então, virá o \MAG{fim}.
        }
    \end{frame}
