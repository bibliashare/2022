...
%%%-----------------------------------------------------------------------------------------------
    ...
    \begin{frame}
        \QUOTE{%
            ...
            sinal haverá da tua vinda e do \MAG{fim do mundo}? \\[\bigskipamount]
            %-----!j 92 -i12
            \ver{(A21) Mt~24.3}~%
            Estando ele sentado no monte das Oliveiras, seus discípulos aproximaram-se  dele
            em particular, dizendo: Dize-nos quando essas coisas  acontecerão  e  que  sinal
            haverá da tua vinda e do \MAG{fim do mundo}.
        }
    \end{frame}
